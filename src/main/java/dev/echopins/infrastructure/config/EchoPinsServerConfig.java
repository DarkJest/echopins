package dev.echopins.infrastructure.config;
...
public final class EchoPinsServerConfig {
    ...
    static {
        ...
        OPERATOR_BYPASS_LIMITS = BUILDER
                ...
                .define("operatorBypassLimits", true);
        BUILDER.pop();
        ...
        MAX_RECORDING_SECONDS = BUILDER
                ...
                .defineInRange("maxRecordingSeconds", 30, 1, 600);
        MIN_RECORDING_MILLIS = BUILDER
                ...
                .defineInRange("minRecordingMillis", 700, 100, 10_000);
        RECORDING_SESSION_TIMEOUT_SECONDS = BUILDER
                ...
                .defineInRange("recordingSessionTimeoutSeconds", 60, 5, 900);
        SUPPRESS_PROXIMITY_WHILE_RECORDING = BUILDER
                ...
                .define("suppressProximityBroadcastWhileRecording", true);
        BUILDER.pop();
        ...
        MAX_PINS_NEARBY = BUILDER
                ...
                .defineInRange("maxPinsNearby", 16, 1, 512);
        MAX_CAPTION_LENGTH = BUILDER
                ...
                .defineInRange("maxCaptionLength", 96, 0, 256);
        MAX_PRIVATE_RECIPIENTS = BUILDER
                ...
                .defineInRange("maxPrivateRecipients", 16, 1, 64);
        BUILDER.pop();
        ...
        DISCOVERY_RADIUS = BUILDER
                ...
                .defineInRange("discoveryRadius", 56.0D, 8.0D, 256.0D);
        INTERACTION_RADIUS = BUILDER
                ...
                .defineInRange("interactionRadius", 6.0D, 1.0D, 64.0D);
        MAX_CREATION_DISTANCE = BUILDER
                ...
                .defineInRange("maxCreationDistance", 8.0D, 1.0D, 64.0D);
        PLAYBACK_AUDIO_DISTANCE = BUILDER
                ...
                .defineInRange("playbackAudioDistance", 16.0D, 2.0D, 128.0D);
        MAX_SYNCED_PINS_PER_PLAYER = BUILDER
                ...
                .defineInRange("maxSyncedPinsPerPlayer", 64, 8, 512);
        ...
        DEFAULT_EXPIRY_HOURS = BUILDER
                ...
                .defineInRange("defaultExpiryHours", 168, 0, 8_760);
        ALLOW_PERMANENT_PINS = BUILDER
                ...
                .define("allowPermanentPins", true);
        BUILDER.pop();
        ...
        CREATE_COOLDOWN_SECONDS = BUILDER
                ...
                .defineInRange("createCooldownSeconds", 5, 0, 3_600);
        PLAYBACK_COOLDOWN_MILLIS = BUILDER
                ...
                .defineInRange("playbackCooldownMillis", 400, 0, 60_000);
        MAX_CONCURRENT_PLAYBACKS_PER_PLAYER = BUILDER
                ...
                .defineInRange("maxConcurrentPlaybacksPerPlayer", 3, 1, 16);
        REQUEST_BURST_CAPACITY = BUILDER
                ...
                .defineInRange("requestBurstCapacity", 30, 1, 500);
        REQUEST_REFILL_PER_SECOND = BUILDER
                ...
                .defineInRange("requestRefillPerSecond", 10.0D, 0.1D, 200.0D);
        BUILDER.pop();
        ...
        MAX_AUDIO_BYTES_PER_PIN = BUILDER
                ...
                .defineInRange("maxAudioBytesPerPin", 262_144, 1_024, 8_388_608);
        MAX_TOTAL_AUDIO_STORAGE_BYTES = BUILDER
                ...
                .defineInRange("maxTotalAudioStorageBytes", 1_073_741_824L, 1_048_576L, 1_099_511_627_776L);
        BUILDER.pop();
        ...
        EXPIRED_PIN_CLEANUP_INTERVAL_SECONDS = BUILDER
                ...
                .defineInRange("expiredPinCleanupIntervalSeconds", 60, 5, 3_600);
        EXPIRED_PIN_CLEANUP_BATCH = BUILDER
                ...
                .defineInRange("expiredPinCleanupBatch", 32, 1, 1_000);
        ...
        ORPHAN_CLEANUP_INTERVAL_MINUTES = BUILDER
                ...
                .defineInRange("orphanCleanupIntervalMinutes", 30, 1, 1_440);
        BUILDER.pop();
